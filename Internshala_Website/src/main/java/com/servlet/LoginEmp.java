...
public class LoginEmp extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(email.equals("training@jalaacademy.com") && password.equals("jobprogram")) {
...
//	            out.println("window.location.href = 'home.jsp';"); // Redirect to welcome page after successful login
			 ...
			 out.println("<script>");
	            ...
	            out.println("window.location.href = 'index.jsp';"); // Redirect back to login page after failed login
	            out.println("</script>");
		}
	}
